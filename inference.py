...
def main(args):
    ...
    for task in infer_config.test_case:
        ...
        _video_frames = run_pipeline(pipeline, image_pixels, pose_pixels, device, task)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--inference_config", type=str, default="configs/test.yaml"
    )  # ToDo
    parser.add_argument(
        "--output_dir", type=str, default="outputs/", help="path to output"
    )
    parser.add_argument(
        "--no_use_float16",
        action="store_true",
